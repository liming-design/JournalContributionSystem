...
<body overflow: auto">
    ...
    <form id="form2" runat="server">
        ...
        <%--width:60%;--%>
             <div class="container" style=" width:940px;min-height:820px;">     
                        <div class="row" style="height:10px;">
                         ...
                         <div class="row" style="height:50px;">
                            ...
                            <div class="col-xs-1 col-md-1 col-sm-1">
                              <button class=" btn" style="background-color:#337AB7;color: white;" onclick="OnConditionChange()">
       ...
       <div  style=" background-image:url('Files/img/bottom2.jpg') ;background-size: 100% 100%;background-repeat:no-repeat;position:relative;text-align:center;padding:0px;margin:0px;margin-top:50px; width:100%; height: 102px; "> 
