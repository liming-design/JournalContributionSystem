...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
   ...
   <style>
        ...
        #foot{
            position: absolute;left: 0;right: 0; color:#424242;margin: auto;margin-top: 390px;
            height: 100px;width: 500px;
        }
        .content3{
            margin-left:150px;margin-top:50px;
            font-size: 20px;width: 500px;height: 200px;
        }
        .content3 input {
            font-size: inherit;display: inline;width: 250px;
            height: 40px;
        }
        .content3 :nth-child(2) {
                width: 134px;margin-right: 20px;
        }
        .content3 textarea{
            font-size: inherit;resize:none;width: 500px;height: 150px;
            margin-bottom: 30px;
        }
        .content3 button{
            float: right;width: 70px;height: 40px;font-size: inherit;
        }
    </style>
...
<body >
            ...
            <div id="content"  class="tab-content vertical-tab-content col-xs-10">
                <div  role="tabpanel" class="tab-pane active" id="tab1">
                    <div style=" margin-left:50px;margin-top:60px;">                        
                        <input  class="form-control myinput" id="name"  placeholder="请输入检索词"/>
                        <button  class="mybut btn btn-success"id="search" >
                            检索
                        </button>
    ...
    <div id="foot" align="center"style="color:#606266" >
        ...
        <p >备注说明：目前该系统为1.0测试版，如您在使用过程中遇到问题请及时反馈。由于期刊的官网地址和投稿方式会发生变更，也请您反馈给我们。让我们共同把他变得更加完美。</p>           
    </div>
